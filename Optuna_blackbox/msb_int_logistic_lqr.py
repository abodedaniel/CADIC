...
class logistic_agent():
    ...
    def switch(self,init_ch, cum_sumk, LQR, LQR_S0, LQR_S1, LQR_S2):
        ...
        subn_channel[to_switch_to_two_channels,0] = init_ch[to_switch_to_two_channels] #the first channel is init
        ...
        to_switch_to_init_channel = np.logical_and(np.invert(to_switch_for_improvement), LQR >= LQR_S2)
        subn_channel[to_switch_to_init_channel,:] = np.expand_dims(init_ch[to_switch_to_init_channel],-1)
        return subn_channel
    ...
    def act(self, state, params, sumint, init_ch):
        ...
        Ch_alloc = self.switch(init_ch, cum_sumk, LQR_int, LQR_S0, LQR_S1, LQR_S2)
        return Ch_alloc